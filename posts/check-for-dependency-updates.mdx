...
Looking for an easier way to update your dependencies? I ran across [npm-check-updates](https://github.com/raineorshine/npm-check-updates) a month or two ago and it makes updating dependencies way more simple. All you gotta do is type `ncu` and it'll show you what updates are available. Then type
